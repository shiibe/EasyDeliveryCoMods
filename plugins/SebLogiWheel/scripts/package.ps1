param(
    ...
    [string]$Project = "src/SebLogiWheel/SebLogiWheel.csproj"
)

$ErrorActionPreference = "Stop"

$repoRoot = Split-Path -Parent $PSScriptRoot
$pluginName = "SebLogiWheel"
...
$outputDir = Join-Path (Join-Path $repoRoot "src\SebLogiWheel") ("bin\" + $Configuration + "\net472")
...
# Optional SFX bundled into plugins/SebLogiWheel/sfx
